TITLE Sum, Average, Largest Number        (ascii_pgm.asm)

; Greg McGlathery
; CS 340
; This program takes an array and performs various calculatios
; Finds the average of the array, sum, remainder, and find the largest value
; In this program, however, we do not call DumpRegs.  We print ASCII values
